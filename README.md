...
### Admin's Rights
- `/admin/teams` - Листинг всех команд с участниками в них
- `/admin/users` - Листинг всех пользователей
...
Также есть раздел с make-командами, необходимыми для запуска тестовой базы и самих тестов
```bash
...
Получается, что алгоритм масштабируется линейно по времени, но плохо по памяти при больших наборах данных (особенно 500 PR).
